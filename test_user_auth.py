...
class TestUserAuth:
    ...
    def test_user_auth(self):
        ...
        assert self.user_id_from_auth_method == user_id_from_auth_method, "User id from auth method is not equal to " \
                                                                          "user " \
    ...
    def test_negative_auth_check(self, condition):
        ...
        user_id_from_check_auth = response2.json()["user_id"]

        assert user_id_from_check_auth == 0, f"user id authorized with condition {condition}"
